...
mhw2 <- mhw$climatology %>%
        filter(between(t, as.Date("2018-07-30"), as.Date("2020-02-10")))
...
mhw2.plot <- ggplot(data = mhw2, aes(x = t)) +
  ...
  theme_pubr() + theme(legend.position = "none") +
    ...
    scale_x_date(limits = as.Date(c("2018-07-30", "2020-02-10")), expand = c(0,0), date_breaks = "1 month")
...
incidence.shidagaura.plot <- ggplot(data = incidence.shidagaura.data, aes(x = as.Date(Date), y = Incidence)) + 
  ...
  labs(y = expression(atop(paste(bold("New Occurrences")), paste("(Incidence)"))))+
